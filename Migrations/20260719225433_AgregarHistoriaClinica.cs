        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    observaciones_generales = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    activa = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Historia_Clinica", x => x.id_historia);
                    table.ForeignKey(
                        name: "FK_Historia_Clinica_Paciente_id_paciente",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Historia_Clinica_id_paciente",
